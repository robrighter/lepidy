  ...
  async load(): Promise<ShellState> {
    return {
      ...
      snapshot: {
        ...
        channels: [
          { id: "channel-eng", kind: "public", slug: "eng", name: "Engineering", isMember: true, postMode: "open", formDefinition: null, sortMode: "chronological", sortEmoji: null, statusDefinitions: [], mainStatusLabel: "Main", canManageQueue: true },
          { id: "channel-release", kind: "public", slug: "release", name: "Release", isMember: true, postMode: "open", formDefinition: null, sortMode: "chronological", sortEmoji: null, statusDefinitions: [], mainStatusLabel: "Main", canManageQueue: true },
          { id: "channel-design", kind: "private", slug: "design", name: "Design", isMember: true, postMode: "open", formDefinition: null, sortMode: "chronological", sortEmoji: null, statusDefinitions: [], mainStatusLabel: "Main", canManageQueue: true },
        ],
        agents: [
