...
| D05 | Vault sharing and release | Preserve the user-held account vault key; choose supported delivery modes; phone-to-runner encryption, multi-owner wraps, device-mediated proxy, recovery and lost devices; state the threat model for server-delivered browser code |
