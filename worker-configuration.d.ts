/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 4ed9aa765800f1860e41e3f83dbefa27)
// Runtime types generated with workerd@1.20260908.1 2026-09-05 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ACCOUNTS: DurableObjectNamespace<import("./custom-worker").Accounts>;
	WORKSPACE: DurableObjectNamespace<import("./custom-worker").Workspace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "Accounts" | "Workspace";
	}
