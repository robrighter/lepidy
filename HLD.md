...
- **Backup beyond 30 days.** PITR covers a rolling month. Anything longer is the alarm-driven R2 export (§3.9), which is designed but has no retention policy attached to it yet — and that policy is a compliance answer as much as a technical one.
